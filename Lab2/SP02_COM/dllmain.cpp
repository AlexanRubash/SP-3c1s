...
{ 0x02fe8a5e, 0x281b, 0x4e3a, { 0x8f, 0x87, 0x6c, 0x54, 0x4d, 0xed, 0xa9, 0x94 } };// {02fe8a5e-281b-4e3a-8f87-6c544deda994}

const WCHAR* FNAME = L"SP02_sasha.dll";
const WCHAR* VerInd = L"SP02_sasha.1.0";
const WCHAR* ProgId = L"SP02_sasha.1";
